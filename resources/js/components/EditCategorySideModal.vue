...
export default {
  ...
  data: () => ({
    ...
    created() {
        this.form.display_name = this.category.display_name;
        this.form.description = this.category.description;
        this.form.income = this.category.income;
        this.form.exclude_budget = this.category.exclude_budget;
        this.form.exclude_totals = this.category.exclude_totals;

        this.toggleIncomeActive = this.category.income === 0 ? false : true;
        this.toggleBudgetActive= this.category.exclude_budget === 0 ? false : true;
        this.toggleTotalActive= this.category.exclude_totals === 0 ? false : true;
    },
